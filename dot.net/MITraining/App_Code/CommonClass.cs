...
//{
	public class CommonClass : System.Web.UI.Page 
	{
        ...
        public DataSet fill()
        {
            ...
            DataSet ds = list.RunSPReturnDataSet("Enquiry_list");
            return ds;


        }

        public DataSet Astrofill()
        {

            CommonClass list = new CommonClass();
            DataSet ds = list.RunSPReturnDataSet("Astrology_List");
            return ds;


        }

        public DataSet AstroDetailsfill()
        {

            CommonClass list = new CommonClass();
            DataSet ds = list.RunSPReturnDataSet("DetailAstro", new SqlParameter("id", Session["Astrodetail"]));
            return ds;
        ...
        //    int res = com.RunSP("delete_enq", new SqlParameter("id", id));
        ...
        public DataSet filldetails()
        {
            ...
            CommonClass com = new CommonClass();
            return com.RunSPReturnDataSet("details_view", new SqlParameter("id", Session["detail"]));
