<%@ page language="C#" autoeventwireup="true" inherits="Franchise, App_Web_-p6c43jy" masterpagefile="~/MasterPage.master" %>

<asp:Content ID="TestMasterpageContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

<div id="Heading"> &nbsp;Franchise</div>
                 ...
                 <td width="100%" >
                    <table  class="celltable" style="BORDER-COLLAPSE: collapse" bordercolor="#111111"  cellspacing="0" cellpadding="0" width="100%" border="0">
                     <tbody>
                        ...
                        <tr>
                            <td class="pad1" height="500" valign="top" >
                                Write content here
                            </td>
                        </tr>
                     </tbody>
