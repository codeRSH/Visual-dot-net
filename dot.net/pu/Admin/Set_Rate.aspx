<%@ page language="C#" autoeventwireup="true" inherits="Set_Rate, App_Web_mb1_hneu" masterpagefile="~/Admin/AdminMasterPage.master" %>
                 ...
                 <td width="100%">
                  <table class="celltable" border="0"  style="BORDER-COLLAPSE: collapse" bordercolor="#111111" cellspacing="5" cellpadding="5" width="100%" >
                    <tbody>
                       ...
                       <tr>
                            <td  align="center" valign="top" width="100%" height="480" >
                                <asp:DataGrid ID="grdRate" Runat="server" CssClass="grid" Width="100%" DataKeyField="ID" AutoGenerateColumns="false" OnEditCommand="MyDataGrid_Edit" OnCancelCommand="MyDataGrid_Cancel"
                                    ...
                                    <AlternatingItemStyle BackColor="#FFE0C0" />
                                     ...
                                     <Columns>
                                        ...
                                        <EditItemTemplate>
                                         ...
                                         <asp:TemplateColumn HeaderText="Level" SortExpression="Level" ItemStyle-Width="40%">
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container.DataItem, "Level") %>
                                        </ItemTemplate>
                                        <EditItemTemplate>
				                             <asp:TextBox ID="txtLevel" runat="server" Text='  <%# DataBinder.Eval(Container.DataItem, "Level")%>'></asp:TextBox>
			                            </EditItemTemplate>
                                        </asp:TemplateColumn>
